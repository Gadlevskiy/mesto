...
function handleCreateCard(el) {
  ...
  userTemplate.querySelector('.elements__delete-btn').addEventListener('click', handleDeleteCard)
  return userTemplate
}
...
function submitContentToCard(evt) {
  evt.preventDefault()
  const newCard = {name: inputContentName.value, link: inputContentLink.value }
